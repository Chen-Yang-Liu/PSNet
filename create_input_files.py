...
if __name__ == '__main__':
    ...
    create_input_files(dataset='LEVIR_CC',
                       karpathy_json_path=r'D:\Dataset\Caption\change_caption\Levir-CC-dataset\LevirCCcaptions.json',
                       image_folder=r'D:\Dataset\Caption\change_caption\Levir-CC-dataset\images',
